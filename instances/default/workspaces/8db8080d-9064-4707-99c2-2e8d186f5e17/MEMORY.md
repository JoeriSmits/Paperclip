...
## Content Source: Personal Experience FIRST

**Critical lesson (2026-04-03):** Joeri explicitly rejected the news-scan approach. Content must come from his personal experiences, not general news monitoring. Many others already do news → LinkedIn. Joeri's differentiation is authenticity and firsthand perspective.

**Content inputs (in priority order):**
1. Meeting transcripties (Joeri maakt er veel bij Webbio en elders)
2. Obsidian notes (persoonlijke kennis, relaties, inzichten)
3. Concrete builds / projects (iets wat hij heeft gebouwd of geleerd die week)
4. Nieuws ALLEEN als Joeri er directe ervaring mee heeft ("dit zie ik dagelijks")

**Infrastructure in progress:**
- Sage: content knowledge space voor transcripties (JOEA-32)
- Tommy: Obsidian → content pipeline design (JOEA-23)
- Rex: content analyse workflow (JOEA-24, blocked on intake spec)

Never pitch news-only hooks again. Always ask: "heeft Joeri dit zelf gedaan/gebouwd/meegemaakt?"
